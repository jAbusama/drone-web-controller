...
export function DroneCameraController() {
	...
	const onCaptureBillboard = debounce(() => {
		setInstruction(DroneCommandValues.CAMERA);
	}, 200);
	return (
		<Card title='Camera Controller' className='flex justify-center'>
			<div className='flex justify-center items-center'>
				<Button className='p-8' onClick={onCaptureBillboard}>
					<svg
